...
```
sudo wget http://www.nginxwebui.cn/download/nginxWebUI-2.2.2.jar
```
...
```
sudo nohup java -jar -Xmx64m nginxWebUI-2.2.2.jar --server.port=8080 --project.home=/home/nginxWebUI/ > /dev/null &
```
...
```
docker build -t nginxwebui:2.2.2 .
```
