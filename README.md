 ...
 **注意：本项目需要在sudo下运行系统命令，极容易被黑客利用，请一定修改密码为复杂密码**
...
```
sudo wget http://www.nginxwebui.cn/download/nginxWebUI-1.8.0.jar
```
...
```
sudo nohup java -jar -Xmx64m nginxWebUI-1.8.0.jar --server.port=8080 --project.home=/home/nginxWebUI/ > /dev/null &
```
